...
class TestHandlers:
    ...
    async def test_compaction_is_an_owner_operation_with_result_metadata(
        ...
        monkeypatch.setattr("agent_comms.acp.backend.compact_session", compact_session)
        ...
        assert agent._comms.agent_info_of("proj").context_used == 1000
